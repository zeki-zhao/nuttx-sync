...
// I2C RST
#define GPIO_I2C_RST (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_PULLDOWN|GPIO_SPEED_50MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTD|GPIO_PIN11)
// I2C INT
#define GPIO_I2C_INT (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_PULLDOWN|GPIO_SPEED_50MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTD|GPIO_PIN13)
...
#define GPIO_LTDC_DISP       (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_PULLUP|GPIO_SPEED_50MHz|\
                              GPIO_OUTPUT_SET|GPIO_PORTD|GPIO_PIN4)   
#define GPIO_LTDC_BL         (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_PULLUP|GPIO_SPEED_50MHz|\
...
#define GPIO_TOUCH_INT2     (GPIO_INPUT|GPIO_FLOAT|GPIO_SPEED_50MHz|GPIO_PORTD|GPIO_PIN13)  
