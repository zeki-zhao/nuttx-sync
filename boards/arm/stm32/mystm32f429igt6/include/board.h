...
// I2C INT
#define GPIO_I2C_INT (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_PULLDOWN|GPIO_SPEED_50MHz|GPIO_OUTPUT_CLEAR|GPIO_PORTD|GPIO_PIN12)
...
#define GPIO_TOUCH_RST      (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_PULLDOWN|GPIO_SPEED_50MHz|\
